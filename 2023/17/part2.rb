...
until queue.empty?
  ...
  if new_point.x >= 0 && state.last_dir != :right
    valid = if state.last_dir != :left && !state.last_dir.nil?
      state.momentum >= 4 && state.momentum <= 10
    else
      state.momentum <= 10
    end
  ...
  if new_point.x <= x_max && state.last_dir != :left
    valid = if state.last_dir != :right && !state.last_dir.nil?
      state.momentum >= 4 && state.momentum <= 10
    else
      state.momentum <= 10
    end
  ...
  if new_point.y >= 0 && state.last_dir != :down
    valid = if state.last_dir != :up && !state.last_dir.nil?
      state.momentum >= 4 && state.momentum <= 10
    else
      state.momentum <= 10
    end
  ...
  if new_point.y <= y_max && state.last_dir != :up
    valid = if state.last_dir != :down && !state.last_dir.nil?
      state.momentum >= 4 && state.momentum <= 10
    else
      state.momentum <= 10
    end
